...
namespace raytracing
{
    ...
    public class Screen
    {
        ...
        {
            // X treba skalirati na [0, size] te translatirati na [-size / 2, size / 2]
            // Y treba skalirati na [0, size], obrnuti na [0, - size] te translatirati na
            // [size / 2, - size / 2]
            return new Point(
                size * i / resolution - size / 2, 
                size / 2 - size * j / resolution, 
                0);
        }
    }
}